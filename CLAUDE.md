...
```
nodes/ApifyFuelprices/   # Base template node (TypeScript, JSON, SVG)
...
- `nodes/ApifyFuelprices/` is the **code template**, not a real node. Do not treat it as a finished integration.
