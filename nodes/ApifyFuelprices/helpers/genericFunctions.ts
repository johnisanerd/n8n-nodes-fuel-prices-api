...
import { ClassNameCamel, X_PLATFORM_APP_HEADER_ID, X_PLATFORM_HEADER_ID } from '../ApifyFuelprices.node';
...
/**
 * Fetch the Actor run's dataset items as a plain array (one object per gas station).
